...
Basics} tutorial. In addition, both the Markdown source for this article and
its translation into LaTeX will be available for download. (TODO: add link.)
...
% We have to cheat a little bit here and use a fake \end{verbatim} macro,
% because the verbatim environment doesn't nest.
\begin{quote}
\begin{verbatim}
Here we see the classic C "hello world":
